    ...
    credits:Button('速度', 'WalkspeedSlider', 16, 16, 99999999,false, function(Value)
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = Value
end)
    credits:Button('跳跃', 'JumpPowerSlider', 50, 50, 99999999,false, function(Value)
    game.Players.LocalPlayer.Character.Humanoid.JumpPower = Value
end)
    credits:Button('重力', 'GravitySlider', 198, 198, 999999999,false,function(Value)
    game.Workspace.Gravity = Value
end)
    credits:Button('高度', 'Slider', 2, 2, 9999,false, function(Value)
    game.Players.LocalPlayer.Character.Humanoid.HipHeight = Value
end)
    credits:Button('相机焦距上限', 'ZOOOOOM OUT!',  128, 128, 200000,false, function(Value)
    game:GetService("Players").LocalPlayer.CameraMaxZoomDistance = Value
end)
    credits:Button('相机焦距（正常70）', 'Sliderflag', 70, 0.1, 250, false, function(v)
        game.Workspace.CurrentCamera.FieldOfView = v
end)
    credits:Button('健康值上限', 'Sliderflag',  120, 120, 999999999,false, function(Value)
    game.Players.LocalPlayer.Character.Humanoid.MaxHealth = Value
end)
    credits:Button('玩家健康值', 'Sliderflag',  120, 120, 999999999,false, function(Value)
